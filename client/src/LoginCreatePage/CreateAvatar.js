...
function CreateAvatar(props) {
  ...
  for (var x = 0; x < 4; x++, gender++) {
    ...
    avatarUrl.push(
      `${avatarurl}avatarStyle=${avatarFeatures["avatar-style"]}&topType=${avatarFeatures["topType"]}&accessoriesType=${avatarFeatures["accessoriesType"]}&hairColor=${avatarFeatures["hairColor"]}&facialHairType=${avatarFeatures["facialHairType"]}&clotheType=${avatarFeatures["clotheType"]}&eyeType=${avatarFeatures["avatar-style"]}&eyebrowType=${avatarFeatures["eyeType"]}&mouthType=${avatarFeatures["mouthType"]}&skinColor=${avatarFeatures["skinColor"]}`
    );
  }
        ...
        <div className="Create-btnc">
          <div className="popup-bg">
            <button id="Create-btn" onClick={handleClick}>
              <span id="Text-gradient">Create Profile</span>
            </button>
          </div>
        </div>
      </div>
